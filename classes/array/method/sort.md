...
```parser3
^массив.sort[ключ;значение]{функция_сортировки_по_строке}
```
```parser3
^массив.sort[ключ;значение]{функция_сортировки_по_строке}[направление_сортировки]
```
```parser3
^массив.sort[ключ;значение](функция_сортировки_по_числу)
```
```parser3
^массив.sort[ключ;значение](функция_сортировки_по_числу)[направление_сортировки]
```
