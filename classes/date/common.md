...
Обычно класс оперирует локальными датой и временем, однако можно узнать значение хранимой им даты/времени в произвольном часовом поясе, см. `^[date](/class/date/).[roll](/class/date/method/roll/)[TZ;…]`.
