...
**фильтр** — строка с регулярным выражением (см. метод `[match](/class/string/method/match/)` класса `[string](/class/string/)`) или объект `regex` ***[3.4.0]***. Без указания фильтра будут выведены все найденные по заданному пути файлы.
